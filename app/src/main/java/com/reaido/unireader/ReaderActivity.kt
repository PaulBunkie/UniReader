...
class ReaderActivity : AppCompatActivity() {
                ...
                document.body.addEventListener('click', function(e) {
                    ...
                    if (fix) {
                        ...
                        if (replacement) {
                            ...
                            var left = Math.max(10, Math.min(window.innerWidth - tw - 10, rect.left + rect.width/2 - mw/2));
        ...
        val html = """
            ...
            <body data-mode="paged" style="background-color: $bgColor !important; margin: 0; padding: 0;">
                ...
                <script type="text/javascript">
                    ...
                    function appendChapter(index, html, lang, jumpToLast, anchor, scrollToNew, stickToIndex, targetPage, targetIdx) {
                        ...
                        if (jumpToLast || anchor || targetPage >= 0 || targetIdx >= 0) {
                    ...
                    function prependChapter(index, html, lang, goToNew, keepIndex, targetPage, targetIdx) {
                        var container = document.getElementById('chapters-container');
                        if (document.getElementById('chapter-' + index)) return;
    ...
    private fun loadInitialPagedChapters() {
        ...
        loadAndAppendChapter(finalPos.first, targetIdx = idxToUse, jumpToLast = jumpToLast, anchor = anchorToUse, targetPage = pageToUse) {
    ...
    private fun loadInitialSeamlessChapters() {
        ...
        isJumpingToChapter = true
        loadAndAppendChapter(finalPos.first, targetIdx = idxToUse) {
    ...
    private fun loadAndAppendChapter(
        ...
        webView.evaluateJavascript("appendChapter($index, `$escapedHtml`, $langArg, $jumpToLast, $anchorArg, $scrollToNew, $stickToIndexArg, $targetPage, $targetIdx);") {
            isChapterLoading = false
            webView.evaluateJavascript("applyHighlights('${getHighlightsJson(index)}')", null)
            onFinished?.invoke()
        }
