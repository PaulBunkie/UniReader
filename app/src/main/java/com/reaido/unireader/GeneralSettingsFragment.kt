...
class GeneralSettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val switchKeepScreenOn = view.findViewById<MaterialSwitch>(R.id.switchKeepScreenOn)
        ...
        switchKeepScreenOn.isChecked = activity.settings.keepScreenOn
        switchKeepScreenOn.setOnCheckedChangeListener { _, isChecked ->
            activity.settings.keepScreenOn = isChecked
            activity.settings.save(activity)
            activity.applyKeepScreenOn(isChecked)
        }
